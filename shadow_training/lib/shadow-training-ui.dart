    ...
    return Ink(
      ...
      child: IconButton(
        ...
        onPressed: currentScreen == UIScreen.playing
            ? null
            : () {
                currentScreen = currentScreen == UIScreen.help
                    ? UIScreen.home
                    : UIScreen.help;
                update();
              },
    ...
    return Ink(
      ...
      child: IconButton(
        ...
        onPressed: currentScreen == UIScreen.playing
            ? null
            : () {
                currentScreen = currentScreen == UIScreen.credits
                    ? UIScreen.home
                    : UIScreen.credits;
                update();
              },
            ...
            children: <Widget>[
              Column(
                children: <Widget>[
                  ...
                  creditRole('Published by', 'Alekhin Games',
                      url: 'https://alekhin.games'),
                  creditRole('Code', 'Alekhin',
                      handle: '@japalekhin', url: 'https://jap.alekhin.io'),
                  creditRole('Graphics', 'Eman',
                      url: 'https://emancipated.art'),
